...
export const seedProductCatalog = [
  ...
  },
  {
    name: "PlayStation 5",
    description:
      "Powerful gaming console with ultra-fast SSD performance, crisp 4K output, and immersive controller feedback. Built for smooth gameplay, streaming, and home entertainment.",
    category: "Accessories",
    price: 649.99,
    offerPrice: 579.99,
    stock: 13,
  ...
  },
  {
    ...
    offerPrice: 1499.99,
    stock: 5,
    promoCode: "BIGSCREEN4K",
    image: [
      "/product-seeds/projector_image.png"
    ]
  },
  {
    name: "Realme 310 Airpods",
    description:
      "Compact true wireless earbuds with balanced sound, quick pairing, and a pocket-friendly charging case. A simple everyday audio pick for music, calls, and commuting.",
    category: "Earphone",
    price: 79.99,
    offerPrice: 59.99,
    stock: 16,
  ...
  },
  {
    ...
    description:
      "Premium smartphone with a bright AMOLED display, fast performance, flagship cameras, and long battery life. Built for multitasking, gaming, photography, and everyday use.",
    category: "Smartphone",
    price: 1199.99,
    offerPrice: 1099.99,
    stock: 11,
