  ...
  switch (mode) {
    case "size":
      return {
        ...
        helperText: "Enter sizes separated by commas or new lines.",
      };
    case "color":
      return {
        mode,
        ...
        helperText: "Enter color choices separated by commas or new lines.",
      };
    case "storage":
      return {
        mode,
        ...
        helperText: "Enter storage configurations separated by commas or new lines. Add colors in the color field above.",
      };
    default:
      return {
        mode,
        ...
        helperText: "Enter the buy options for this product separated by commas or new lines.",
      };
  }
};
